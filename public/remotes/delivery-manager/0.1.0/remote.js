...
const $t = "bb.locale.changed.v1";
let B = localStorage.getItem("locale") || "es";
const v = {};
let _t = async () => ({});
async function ft(r) {
  v[r] ?? (v[r] = {}), v[r][B] || (v[r][B] = await _t());
}
function K(r, t, e) {
  var i, n;
  return (((n = (i = v[r]) == null ? void 0 : i[B]) == null ? void 0 : n[t]) ?? `${r}.${t}?`).replace(/\{\{(\w+)\}\}/g, (o, a) => "");
}
/**
 * @license
 ...
 */
const R = globalThis, W = R.ShadowRoot && (R.ShadyCSS === void 0 || R.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, q = Symbol(), Z = /* @__PURE__ */ new WeakMap();
let nt = class {
  constructor(t, e, s) {
...
const At = (r) => new nt(typeof r == "string" ? r : r + "", void 0, q), gt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: yt, defineProperty: vt, getOwnPropertyDescriptor: Et, getOwnPropertyNames: St, getOwnPropertySymbols: bt, getPrototypeOf: wt } = Object, f = globalThis, G = f.trustedTypes, Ct = G ? G.emptyScript : "", D = f.reactiveElementPolyfillSupport, P = (r, t) => r, V = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Ct : null;
      break;
  ...
  return e;
} }, ot = (r, t) => !yt(r, t), Q = { attribute: !0, type: String, converter: V, reflect: !1, useDefault: !1, hasChanged: ot };
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[P("elementProperties")] = /* @__PURE__ */ new Map(), E[P("finalized")] = /* @__PURE__ */ new Map(), D == null || D({ ReactiveElement: E }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x = globalThis, k = x.trustedTypes, X = k ? k.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ht = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, at = "?" + _, Pt = `<${at}>`, y = document, O = () => y.createComment(""), H = (r) => r === null || typeof r != "object" && typeof r != "function", J = Array.isArray, xt = (r) => J(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Y = /-->/g, tt = />/g, A = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, lt = /^(?:script|style|textarea|title)$/i, Ut = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Ot = Ut(1), S = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), it = /* @__PURE__ */ new WeakMap(), g = y.createTreeWalker(y, 129);
function ct(r, t) {
...
const Ht = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    n += o === C ? h + Pt : l >= 0 ? (s.push(c), h.slice(0, l) + ht + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
...
class M {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const a = t.length - 1, h = this.parts, [c, p] = Ht(t, e);
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(ht)) {
          ...
          h.push({ type: 1, index: n, name: N[2], strings: $, ctor: N[1] === "." ? Tt : N[1] === "?" ? Nt : N[1] === "@" ? Rt : L }), i.removeAttribute(l);
...
class Mt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new T(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new kt(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class T {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), H(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== S && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : xt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    var n;
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = M.createElement(ct(s.h, s.h[0]), this.options)), s);
...
class L {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = b(this, t, e, 0), o = !H(t) || t !== this._$AH && t !== S, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = b(this, a[s + h], e, h), c === S && (c = this._$AH[h]), o || (o = !H(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
I == null || I(M, T), (x.litHtmlVersions ?? (x.litHtmlVersions = [])).push("3.3.1");
const Lt = (r, t, e) => {
...
var rt;
U._$litElement$ = !0, U.finalized = !0, (rt = m.litElementHydrateSupport) == null || rt.call(m, { LitElement: U });
...
class dt extends U {
  constructor() {
    super(...arguments);
    w(this, "basepath", "/apps/delivery-manager");
    w(this, "route", "/");
    w(this, "env");
  }
  async connectedCallback() {
    var e, s;
    super.connectedCallback(), await ft("delivery"), (s = (e = this.env) == null ? void 0 : e.bus) == null || s.addEventListener($t, () => this.requestUpdate());
  }
  render() {
    return Ot`<h2>${K("delivery", "title")}</h2>
      <p>${K("delivery", "intro")}</p>`;
  }
}
w(dt, "styles", gt`
    :host {
  ...
  `);
customElements.define("dlv-shell", dt);
function jt() {
}
export {
  jt as register
