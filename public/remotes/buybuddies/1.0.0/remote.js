...
(function(f, i) {
  (function(s) {
    ...
    var Pe = k.schema, Gt = {
      ...
      var e = {}, t = console.log;
      return D(["debug", "info", "warn", "error"], function(n) {
        var r = console[n];
      ...
      function g(m) {
        if (m)
          for (var S = 0; S < d.length; S++)
            m[d[S]] !== void 0 && this["set" + t(d[S])](m[d[S]]);
      }
      g.prototype = {
        getArgs: function() {
          return this.args;
        ...
        toString: function() {
          var m = this.getFileName() || "", S = this.getLineNumber() || "", x = this.getColumnNumber() || "", $ = this.getFunctionName() || "";
          return this.getIsEval() ? m ? "[eval] (" + m + ":" + S + ":" + x + ")" : "[eval]:" + S + ":" + x : $ ? $ + " (" + m + ":" + S + ":" + x + ")" : m + ":" + S + ":" + x;
        }
      }, g.fromString = function(S) {
        var x = S.indexOf("("), $ = S.lastIndexOf(")"), A = S.substring(0, x), T = S.substring(x + 1, $).split(","), w = S.substring($ + 1);
        if (w.indexOf("@") === 0)
...
`).filter(function(d) {
          ...
          return h.map(function(d) {
            ...
            g = v ? g.replace(v[0], "") : g;
            var y = g.split(/\s+/).slice(1), b = this.extractLocation(v ? v[1] : y.pop()), m = y.join(" ") || void 0, S = ["eval", "<anonymous>"].indexOf(b[0]) > -1 ? void 0 : b[0];
            return new t({
              functionName: m,
              fileName: S,
              lineNumber: b[1],
...
`).filter(function(d) {
          ...
          return h.map(function(d) {
            ...
            var S = m === void 0 || m === "[arguments not available]" ? void 0 : m.split(",");
            return new t({
              functionName: b,
              args: S,
              fileName: v[0],
    ...
    function ur(e, t, n) {
      ...
      function c(o, h) {
        ...
        if (sr(o)) {
          for (var b = [], m = 0, S = o.length; m < S; m++) {
            if (d()) {
              b.push(me);
              break;
            }
    ...
    function cr(e, t, n) {
      if (_(t)) {
        for (var r = 0; r < t.length; ++r) {
          var a = t[r];
          a === null || typeof a != "object" || rt(e, n, a.name, a.variant);
        }
        return e;
      }
    }
    function lr(e) {
      return D(l(e, Boolean), function(t) {
    ...
    var j = /* @__PURE__ */ function() {
      ...
      return t.addMetadata = function(r, a, c) {
        ...
        return {
          payloadVersion: "4",
          exceptions: D(this.errors, function(r) {
            return L({}, r, {
    ...
    function st(e) {
      return e.cause ? [e].concat(st(e.cause)) : [e];
    }
    j.getStacktrace = function(e, t, n) {
      if (ye(e)) return et.parse(e).slice(t);
      try {
      ...
      a === void 0 && (a = 0);
      var o = ut(e, t, r, c), h = o[0], d = o[1], g;
      try {
      ...
      if (h.name === "InvalidError" && g.addMetadata("" + r, "non-error parameter", ot(e)), h.cause) {
        var y, b = st(h).slice(1), m = D(b, function(S) {
          var x = be(S) && ye(S) ? et.parse(S) : [], $ = ut(S, !0, "error cause"), A = $[0];
          return A.name === "InvalidError" && g.addMetadata("error cause", ot(S)), at(A.name, A.message, j.__type, x);
        });
    ...
    }, lt = typeof window == "object" ? window : self, dt = 0;
    for (var Sr in lt)
      Object.hasOwnProperty.call(lt, Sr) && dt++;
    var Er = navigator.mimeTypes ? navigator.mimeTypes.length : 0, Ar = Le((Er + navigator.userAgent.length).toString(36) + dt.toString(36), 4), ft = function() {
      return Ar;
    }, Or = function(t) {
      return typeof t == "string" && /^c[a-z0-9]{20,32}$/.test(t);
    }, ae = 0, Be = 4, $e = 36, ht = Math.pow($e, Be);
    function pt() {
      return Le((Math.random() * ht << 0).toString($e), Be);
    }
    function xr() {
      return ae = ae < ht ? ae : 0, ae++, ae - 1;
    }
    function He() {
      var e = "c", t = (/* @__PURE__ */ new Date()).getTime().toString($e), n = Le(xr().toString($e), Be), r = ft(), a = pt() + pt();
      return e + t + n + r + a;
    }
    He.fingerprint = ft, He.isCuid = Or;
    var gt = He, Nr = /* @__PURE__ */ function() {
      function e() {
        this.id = gt(), this.startedAt = /* @__PURE__ */ new Date(), this._handled = 0, this._unhandled = 0, this._user = {}, this.app = {}, this.device = {};
      }
      var t = e.prototype;
    ...
    }(), Ie = Nr, Pr = X.add, wr = X.clear, ke = X.merge, Cr = "00000", Tr = "https://notify.insighthub.smartbear.com", Rr = "https://sessions.insighthub.smartbear.com", F = function() {
    }, Mr = /* @__PURE__ */ function() {
      function e(n, r, a, c) {
        var o = this;
        r === void 0 && (r = k.schema), a === void 0 && (a = []), this._notifier = c, this._config = {}, this._schema = r, this._delivery = {
          sendSession: F,
          sendEvent: F
        }, this._logger = {
          debug: F,
          ...
          sp: [],
          b: []
        }, this.Client = e, this.Event = Me, this.Breadcrumb = we, this.Session = Ie, this._config = this._configure(n, a), D(a.concat(this._config.plugins), function(g) {
          g && o._loadPlugin(g);
        }), this._depth = 1;
      ...
      return t.addMetadata = function(r, a, c) {
        ...
        ke(this._features, r, this._featuresIndex);
      }, t.clearFeatureFlag = function(r) {
        ...
        var a = ct(this._cbs.s, r, "onSession", this._logger);
        ...
        if (r = typeof r == "string" ? r : "", c = typeof c == "string" && p(s, c) ? c : "manual", a = typeof a == "object" && a !== null ? a : {}, !!r) {
          var o = new we(r, a, c), h = ct(this._cbs.b, o, "onBreadcrumb", this._logger);
          if (h) {
        ...
        }), r.context = r.context || this._context, r._metadata = L({}, r._metadata, this._metadata), r._user = L({}, r._user, this._user), r.breadcrumbs = this._breadcrumbs.slice(), ke(r._features, this._features, r._featuresIndex), this._config.enabledReleaseStages !== null && !p(this._config.enabledReleaseStages, this._config.releaseStage))
...
`));
    ...
    }, De = Mr, Q = {}, _t = ["events.[].metaData", "events.[].breadcrumbs.[].metaData", "events.[].request"];
...
metadata was removed`
    ...
    Ue = function(e, t) {
      return t === void 0 && (t = window), {
        sendEvent: function(n, r) {
          ...
          var c = vt(e._config, "notify", "4", t), o = Q.event(n, e._config.redactedKeys), h = new t.XDomainRequest();
          h.onload = function() {
            r(null);
          }, h.onerror = function() {
        ...
        sendSession: function(n, r) {
          ...
          var c = vt(e._config, "sessions", "1", t), o = new t.XDomainRequest();
          o.onload = function() {
            r(null);
      ...
      return t === void 0 && (t = window), {
        sendEvent: function(n, r) {
          ...
          try {
            ...
            }, o.open("POST", a), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Bugsnag-Api-Key", n.apiKey || e._config.apiKey), o.setRequestHeader("Bugsnag-Payload-Version", "4"), o.setRequestHeader("Bugsnag-Sent-At", (/* @__PURE__ */ new Date()).toISOString()), e._config.sendPayloadChecksums && typeof Promise < "u" && Promise.toString().indexOf("[native code]") !== -1 ? mt(t, h).then(function(d) {
        ...
        sendSession: function(n, r) {
          ...
          try {
            ...
            }, o.open("POST", a), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Bugsnag-Api-Key", e._config.apiKey), o.setRequestHeader("Bugsnag-Payload-Version", "1"), o.setRequestHeader("Bugsnag-Sent-At", (/* @__PURE__ */ new Date()).toISOString()), e._config.sendPayloadChecksums && typeof Promise < "u" && Promise.toString().indexOf("[native code]") !== -1 ? mt(t, h).then(function(d) {
              d && o.setRequestHeader("Bugsnag-Integrity", d), o.send(h);
            }).catch(function(d) {
              e._logger.error(d), o.send(h);
            }) : o.send(h);
    ...
    }, yt = /* @__PURE__ */ new Date(), kr = function() {
      yt = /* @__PURE__ */ new Date();
    }, Dr = {
      name: "appDuration",
      load: function(e) {
    ...
    }, bt = "bugsnag-anonymous-id", jr = function(e) {
      try {
        var t = e.localStorage, n = t.getItem(bt);
        return n && /^c[a-z0-9]{20,32}$/.test(n) || (n = gt(), t.setItem(bt, n)), n;
      } catch {
      }
    }, Fr = function(e, t) {
      return e === void 0 && (e = navigator), t === void 0 && (t = window), {
        load: function(n) {
          ...
          t && t.screen && t.screen.orientation && t.screen.orientation.type ? r.orientation = t.screen.orientation.type : t && t.document && (r.orientation = t.document.documentElement.clientWidth > t.document.documentElement.clientHeight ? "landscape" : "portrait"), n._config.generateAnonymousId && (r.id = jr(t)), n.addOnSession(function(a) {
            a.device = L({}, a.device, r), n._config.collectUserIp || $t(a);
          }), n.addOnError(function(a) {
            a.device = L({}, a.device, r, {
              time: /* @__PURE__ */ new Date()
            }), n._config.collectUserIp || $t(a);
          }, !0);
        },
        configSchema: {
          generateAnonymousId: {
    ...
    St.load = function(e) {
      ...
      t || !e._isBreadcrumbTypeEnabled("log") || D(zr, function(n) {
        var r = console[n];
        console[n] = function() {
    ...
    var zr = l(["log", "debug", "info", "warn", "error"], function(e) {
      ...
      return e === void 0 && (e = document), t === void 0 && (t = window), {
        load: function(n) {
          ...
          var g = null, v = function($) {
            g = $;
          }, y = function() {
            var $ = e.currentScript || g;
            if (!$ && !o) {
...
`)), T = $ - 1, w = Math.max(T - 3, 0), M = Math.min(T + 3, A.length);
            return u(A.slice(w, M), function(C, U, se) {
              return C[w + 1 + se] = U.length <= Et ? U : U.substr(0, Et), C;
            }, {});
          };
          n.addOnError(function($) {
            $.errors[0].stacktrace = l($.errors[0].stacktrace, function(C) {
              return !/__trace__$/.test(C.method);
            });
            var A = $.errors[0].stacktrace[0], T = function(C) {
            ...
            if (!(A && A.file && T(A.file) !== T(r))) {
              ...
              if (w) {
                var M = w.innerHTML;
                $.addMetadata("script", "content", M.length <= At ? M : M.substr(0, At)), A && A.lineNumber && (A.code = b(A.lineNumber));
              }
            }
          }, !0);
          var m = D(["setTimeout", "setInterval", "setImmediate", "requestAnimationFrame"], function($) {
          ...
          D(["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"], function($) {
            !t[$] || !t[$].prototype || !Object.prototype.hasOwnProperty.call(t[$].prototype, "addEventListener") || (je(t[$].prototype, "addEventListener", function(A) {
              return x(A, Ot);
            }), je(t[$].prototype, "removeEventListener", function(A) {
              return x(A, Ot, !0);
            }));
          });
          function x($, A, T) {
            return T === void 0 && (T = !1), function() {
              ...
              try {
                var M = A(w), C = M.get();
                if (T && $.apply(this, w), typeof C != "function") return $.apply(this, w);
                if (C.__trace__)
    ...
    function xt(e, t) {
      ...
      return t.document.querySelectorAll(n.join("")).length === 1 ? n.join("") : e.parentNode ? xt(e.parentNode, t) + " > " + n.join("") : n.join("");
    }
    var Nt = {};
    Nt = function(e) {
      e === void 0 && (e = window);
          ...
          if ("addEventListener" in e && n._isBreadcrumbTypeEnabled("navigation")) {
            ...
            e.addEventListener("pagehide", r("Page hidden"), !0), e.addEventListener("pageshow", r("Page shown"), !0), e.addEventListener("load", r("Page loaded"), !0), e.document.addEventListener("DOMContentLoaded", r("DOMContentLoaded"), !0), e.addEventListener("load", function() {
              ...
              var c = a.oldURL ? {
                ...
                to: Se(e.location.href, e)
              };
              n.leaveBreadcrumb("Hash changed", c, "navigation");
            }, !0), e.history.pushState && Pt(n, e.history, "pushState", e, !0), e.history.replaceState && Pt(n, e.history, "replaceState", e);
          }
        }
      };
      return t;
        ...
        load: function(r) {
          ...
          function c() {
            if (!(!("addEventListener" in t.XMLHttpRequest.prototype) || !("WeakMap" in t))) {
              ...
              t.XMLHttpRequest.prototype.open = function($, A) {
                this && y.set(this, {
                  method: $,
                  url: A
          ...
          function d() {
            if (!(!("fetch" in t) || t.fetch.polyfill)) {
              var y = t.fetch;
              t.fetch = function() {
                var m = arguments, S = arguments[0], x = arguments[1], $, A = null;
                return S && typeof S == "object" ? (A = S.url, x && "method" in x ? $ = x.method : S && "method" in S && ($ = S.method)) : (A = S, x && "method" in x && ($ = x.method)), $ === void 0 && ($ = "GET"), new Promise(function(T, w) {
        ...
        load: function(n) {
          ...
          function r(c, o, h, d, g) {
            if (h === 0 && /Script error\.?/.test(c))
              ...
              if (g)
                y = n.Event.create(g, !0, v, t, 1), Ct(y.errors[0].stacktrace, o, h, d);
              else if (
                ...
                y = n.Event.create(c, !0, v, t, 1), Ct(y.errors[0].stacktrace, o, h, d);
              n._notify(y);
            }
        ...
        load: function(n) {
          if (!(!n._config.autoDetectErrors || !n._config.enabledErrorTypes.unhandledRejections)) {
            var r = function(a) {
              ...
              o && D(d.errors[0].stacktrace, an(c)), n._notify(d, function(g) {
    ...
    }, z = {}, sn = "Bugsnag JavaScript", on = "8.4.0", un = "https://github.com/bugsnag/bugsnag-js", cn = L({}, k.schema, Gt), I = {
      _client: null,
    ...
    return D(["resetEventCount"].concat(N(De.prototype)), function(e) {
    ...
    }), z = I, z.Client = De, z.Event = Me, z.Session = Ie, z.Breadcrumb = we, z.default = I, z;
  });
})(Ft);
 ...
 */
const Ae = globalThis, Ye = Ae.ShadowRoot && (Ae.ShadyCSS === void 0 || Ae.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ze = Symbol(), Tt = /* @__PURE__ */ new WeakMap();
let Vt = class {
  constructor(i, s, u) {
    if (this._$cssResult$ = !0, u !== Ze) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Ye && i === void 0) {
      ...
      u && (i = Tt.get(s)), i === void 0 && ((this.o = i = new CSSStyleSheet()).replaceSync(this.cssText), u && Tt.set(s, i));
    }
    return i;
  }
  toString() {
...
const vn = (f) => new Vt(typeof f == "string" ? f : f + "", void 0, Ze), mn = (f, ...i) => {
  ...
  return new Vt(s, f, Ze);
}, yn = (f, i) => {
  if (Ye) f.adoptedStyleSheets = i.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet);
...
}, Rt = Ye ? (f) => f : (f) => f instanceof CSSStyleSheet ? ((i) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: bn, defineProperty: $n, getOwnPropertyDescriptor: Sn, getOwnPropertyNames: En, getOwnPropertySymbols: An, getPrototypeOf: On } = Object, q = globalThis, Mt = q.trustedTypes, xn = Mt ? Mt.emptyScript : "", qe = q.reactiveElementPolyfillSupport, ce = (f, i) => f, We = { toAttribute(f, i) {
  switch (i) {
    case Boolean:
      f = f ? xn : null;
      break;
  ...
  return s;
} }, qt = (f, i) => !bn(f, i), Lt = { attribute: !0, type: String, converter: We, reflect: !1, useDefault: !1, hasChanged: qt };
...
let te = class extends HTMLElement {
  ...
  static createProperty(i, s = Lt) {
    if (s.state && (s.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(i) && ((s = Object.create(s)).wrapped = !0), this.elementProperties.set(i, s), !s.noAccessor) {
      ...
      l !== void 0 && $n(this.prototype, i, l);
    }
  }
  static getPropertyDescriptor(i, s, u) {
    const { get: l, set: p } = Sn(this.prototype, i) ?? { get() {
      return this[s];
    }, set(_) {
      this[s] = _;
    } };
  ...
  static finalizeStyles(i) {
    ...
    if (Array.isArray(i)) {
      ...
      for (const l of u) s.unshift(Rt(l));
    } else i !== void 0 && s.push(Rt(i));
    return s;
  }
  static _$Eu(i, s) {
    const u = s.attribute;
  ...
  _$ET(i, s) {
    ...
    if (l !== void 0 && u.reflect === !0) {
      const _ = (((p = u.converter) == null ? void 0 : p.toAttribute) !== void 0 ? u.converter : We).toAttribute(s, u.type);
  ...
  _$AK(i, s) {
    ...
    if (l !== void 0 && this._$Em !== l) {
      const O = u.getPropertyOptions(l), E = typeof O.converter == "function" ? { fromAttribute: O.converter } : ((p = O.converter) == null ? void 0 : p.fromAttribute) !== void 0 ? O.converter : We;
      this._$Em = l;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const le = globalThis, Oe = le.trustedTypes, Bt = Oe ? Oe.createPolicy("lit-html", { createHTML: (f) => f }) : void 0, Kt = "$lit$", V = `lit$${Math.random().toFixed(9).slice(2)}$`, Xt = "?" + V, Nn = `<${Xt}>`, Y = document, fe = () => Y.createComment(""), he = (f) => f === null || typeof f != "object" && typeof f != "function", Qe = Array.isArray, Pn = (f) => Qe(f) || typeof (f == null ? void 0 : f[Symbol.iterator]) == "function", Ke = `[ 	
\f\r]`, ue = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ht = /-->/g, It = />/g, J = RegExp(`>|${Ke}(?:([^\\s"'>=/]+)(${Ke}*=${Ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), kt = /'/g, Dt = /"/g, zt = /^(?:script|style|textarea|title)$/i, wn = (f) => (i, ...s) => ({ _$litType$: f, strings: i, values: s }), Cn = wn(1), ne = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), Ut = /* @__PURE__ */ new WeakMap(), W = Y.createTreeWalker(Y, 129);
function Jt(f, i) {
  if (!Qe(f) || !f.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Bt !== void 0 ? Bt.createHTML(i) : i;
}
const Tn = (f, i) => {
  ...
  for (let O = 0; O < s; O++) {
    const E = f[O];
    let N, R, P = -1, H = 0;
    for (; H < E.length && (_.lastIndex = H, R = _.exec(E), R !== null); ) H = _.lastIndex, _ === ue ? R[1] === "!--" ? _ = Ht : R[1] !== void 0 ? _ = It : R[2] !== void 0 ? (zt.test(R[2]) && (l = RegExp("</" + R[2], "g")), _ = J) : R[3] !== void 0 && (_ = J) : _ === J ? R[0] === ">" ? (_ = l ?? ue, P = -1) : R[1] === void 0 ? P = -2 : (P = _.lastIndex - R[2].length, N = R[1], _ = R[3] === void 0 ? J : R[3] === '"' ? Dt : kt) : _ === Dt || _ === kt ? _ = J : _ === Ht || _ === It ? _ = ue : (_ = J, l = void 0);
    const k = _ === J && f[O + 1].startsWith("/>") ? " " : "";
    p += _ === ue ? E + Nn : P >= 0 ? (u.push(N), E.slice(0, P) + Kt + E.slice(P) + V + k) : E + V + (P === -2 ? O : k);
  }
    ...
    for (; (l = W.nextNode()) !== null && E.length < O; ) {
      if (l.nodeType === 1) {
        if (l.hasAttributes()) for (const P of l.getAttributeNames()) if (P.endsWith(Kt)) {
          const H = R[_++], k = l.getAttribute(P).split(V), K = /([.?@])?(.*)/.exec(H);
          E.push({ type: 1, index: p, name: K[2], strings: k, ctor: K[1] === "." ? Mn : K[1] === "?" ? Ln : K[1] === "@" ? Bn : xe }), l.removeAttribute(P);
        ...
        if (zt.test(l.tagName)) {
          ...
          if (H > 0) {
            ...
            for (let k = 0; k < H; k++) l.append(P[k], fe()), W.nextNode(), E.push({ type: 2, index: ++p });
            l.append(P[H], fe());
          }
        }
...
class ge {
  ...
  _$AC(i) {
    let s = Ut.get(i.strings);
    return s === void 0 && Ut.set(i.strings, s = new pe(i)), s;
  }
  k(i) {
...
const kn = "mf:navigate", Dn = "bb.locale.changed.v1";
let Ge = localStorage.getItem("locale") || "es";
const re = {};
let Un = async () => ({});
async function jn(f) {
  re[f] ?? (re[f] = {}), re[f][Ge] || (re[f][Ge] = await Un());
}
function Je(f, i, s) {
  var l, p;
  return (((p = (l = re[f]) == null ? void 0 : l[Ge]) == null ? void 0 : p[i]) ?? `${f}.${i}?`).replace(/\{\{(\w+)\}\}/g, (_, O) => "");
}
class Wt extends de {
  constructor() {
    super(...arguments);
    oe(this, "basepath", "/apps/buybuddies");
    oe(this, "route", "/");
    oe(this, "env");
  }
  async connectedCallback() {
    var s, u;
    super.connectedCallback(), await jn("buybuddies"), (u = (s = this.env) == null ? void 0 : s.bus) == null || u.addEventListener(Dn, () => this.requestUpdate());
  }
  nav(s) {
    this.dispatchEvent(
      new CustomEvent(kn, { detail: { to: s }, bubbles: !0, composed: !0 })
    );
  }
  render() {
    return Cn`<h2>${Je("buybuddies", "title")}</h2>
      <p>${Je("buybuddies", "intro")}</p>
      <button @click=${() => this.nav(`${this.basepath}/list`)}>
        ${Je("buybuddies", "goList")}
      </button>`;
  }
}
oe(Wt, "styles", mn`
  ...
  `);
customElements.define("bb-shell", Wt);
function Kn(f) {
