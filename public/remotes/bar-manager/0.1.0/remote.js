...
var dn = (d, i, s) => i in d ? fn(d, i, { enumerable: !0, configurable: !0, writable: !0, value: s }) : d[i] = s;
var oe = (d, i, s) => dn(d, typeof i != "symbol" ? i + "" : i, s);
function hn(d) {
...
(function(d, i) {
  (function(s) {
    ...
    (function(e, t) {
      ...
      var r = ["isConstructor", "isEval", "isNative", "isToplevel"], a = ["columnNumber", "lineNumber"], c = ["fileName", "functionName", "source"], o = ["args"], h = ["evalOrigin"], f = r.concat(a, c, o, h);
      function g(m) {
        if (m)
          for (var $ = 0; $ < f.length; $++)
            m[f[$]] !== void 0 && this["set" + t(f[$])](m[f[$]]);
      }
      g.prototype = {
        getArgs: function() {
          return this.args;
    ...
    (function(e, t) {
      ...
      return {
        ...
        extractLocation: function(o) {
          if (o.indexOf(":") === -1)
            return [o];
          var h = /(.+?)(?::(\d+))?(?::(\d+))?$/, f = h.exec(o.replace(/[()]/g, ""));
...
`).filter(function(f) {
          ...
          return h.map(function(f) {
            ...
            var g = f.replace(/^\s+/, "").replace(/\(eval code/g, "("), v = g.match(/ (\((.+):(\d+):(\d+)\)$)/);
            g = v ? g.replace(v[0], "") : g;
...
`).filter(function(f) {
          ...
          return h.map(function(f) {
            ...
            var g = /((.*".+"[^@]*)?[^@]*)(?:@)/, v = f.match(g), y = v && v[1] ? v[1] : void 0, b = this.extractLocation(f.replace(g, ""));
            return new t({
              functionName: y,
              fileName: b[0],
              lineNumber: b[1],
...
`).length ? this.parseOpera9(o) : o.stack ? this.parseOpera11(o) : this.parseOpera10(o);
        ...
        parseOpera9: function(o) {
          for (var h = /Line (\d+).*script (?:in )?(\S+)/i, f = o.message.split(`
`), g = [], v = 2, y = f.length; v < y; v += 2) {
            var b = h.exec(f[v]);
            b && g.push(new t({
              fileName: b[2],
              lineNumber: b[1],
        ...
        parseOpera10: function(o) {
          for (var h = /Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i, f = o.stacktrace.split(`
`), g = [], v = 0, y = f.length; v < y; v += 2) {
            var b = h.exec(f[v]);
            b && g.push(new t({
        ...
        parseOpera11: function(o) {
          var h = o.stack.split(`
`).filter(function(f) {
            return !!f.match(n) && !f.match(/^Error created at/);
          }, this);
          return h.map(function(f) {
            var g = f.split("@"), v = this.extractLocation(g.pop()), y = g.shift() || "", b = y.replace(/<anonymous function(: (\w+))?>/, "$2").replace(/\([^)]*\)/g, "") || void 0, m;
    ...
    j.getStacktrace = function(e, t, n) {
      ...
      a === void 0 && (a = 0);
      var o = ot(e, t, r, c), h = o[0], f = o[1], g;
      try {
    ...
    var st = function(e) {
      ...
      var a, c = 0, o = function(h) {
        var f = n === "error cause" ? "was" : "received";
        r && r.warn(n + " " + f + ' a non-error: "' + h + '"');
        var g = new Error(n + " " + f + ' a non-error. See "' + n + '" tab for more detail.');
    ...
    var Er = navigator.mimeTypes ? navigator.mimeTypes.length : 0, Ar = Le((Er + navigator.userAgent.length).toString(36) + lt.toString(36), 4), ft = function() {
      return Ar;
    }, Or = function(t) {
      return typeof t == "string" && /^c[a-z0-9]{20,32}$/.test(t);
    }, ae = 0, Be = 4, Se = 36, dt = Math.pow(Se, Be);
    function ht() {
      return Le((Math.random() * dt << 0).toString(Se), Be);
    }
    function xr() {
      return ae = ae < dt ? ae : 0, ae++, ae - 1;
    }
    function He() {
      var e = "c", t = (/* @__PURE__ */ new Date()).getTime().toString(Se), n = Le(xr().toString(Se), Be), r = ft(), a = ht() + ht();
      return e + t + n + r + a;
    }
    ...
    var pt = He, Nr = /* @__PURE__ */ function() {
      ...
      return t.addMetadata = function(r, a, c) {
        ...
        var o = u(N(c), function(g, v) {
          ...
          errors: {},
          config: {}
        }), h = o.errors, f = o.config;
        if (c.apiKey) {
          if (!f.apiKey) throw new Error("No Bugsnag API Key set");
          /^[0-9a-f]{32}$/i.test(f.apiKey) || (h.apiKey = "should be a string of 32 hexadecimal characters"), r.endpoints === void 0 && f.apiKey.startsWith(Cr) && (f.endpoints = {
            notify: Tr,
            sessions: Rr
          });
        }
        return this._metadata = L({}, f.metadata), De(this._features, f.featureFlags, this._featuresIndex), this._user = L({}, f.user), this._context = f.context, f.logger && (this._logger = f.logger), f.onError && (this._cbs.e = this._cbs.e.concat(f.onError)), f.onBreadcrumb && (this._cbs.b = this._cbs.b.concat(f.onBreadcrumb)), f.onSession && (this._cbs.s = this._cbs.s.concat(f.onSession)), N(h).length && this._logger.warn(Lr(h, r)), f;
      }, t.getUser = function() {
        return this._user;
      }, t.setUser = function(r, a, c) {
        this._user = {
      ...
      return t === void 0 && (t = window), {
        sendEvent: function(n, r) {
          ...
          h.onload = function() {
            ...
            var f = new Error("Event failed to send");
            e._logger.error("Event failed to send…", f), o.length > 1e6 && e._logger.warn("Event oversized (" + (o.length / 1e6).toFixed(2) + " MB)"), r(f);
          }, h.open("POST", c), setTimeout(function() {
            try {
              h.send(o);
            } catch (f) {
              e._logger.error(f), r(f);
            }
          }, 0);
        },
      ...
      return t === void 0 && (t = window), {
          ...
          try {
            ...
            o.onreadystatechange = function() {
              if (o.readyState === t.XMLHttpRequest.DONE) {
                var f = o.status;
                if (f === 0 || f >= 400) {
                  var g = new Error("Request failed with status " + f);
                  e._logger.error("Event failed to send…", g), h.length > 1e6 && e._logger.warn("Event oversized (" + (h.length / 1e6).toFixed(2) + " MB)"), r(g);
                } else
                  r(null);
              }
            }, o.open("POST", a), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Bugsnag-Api-Key", n.apiKey || e._config.apiKey), o.setRequestHeader("Bugsnag-Payload-Version", "4"), o.setRequestHeader("Bugsnag-Sent-At", (/* @__PURE__ */ new Date()).toISOString()), e._config.sendPayloadChecksums && typeof Promise < "u" && Promise.toString().indexOf("[native code]") !== -1 ? vt(t, h).then(function(f) {
              f && o.setRequestHeader("Bugsnag-Integrity", f), o.send(h);
            }).catch(function(f) {
              e._logger.error(f), o.send(h);
            }) : o.send(h);
          } catch (f) {
            e._logger.error(f);
          }
        ...
        sendSession: function(n, r) {
          ...
          try {
            ...
            }, o.open("POST", a), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Bugsnag-Api-Key", e._config.apiKey), o.setRequestHeader("Bugsnag-Payload-Version", "1"), o.setRequestHeader("Bugsnag-Sent-At", (/* @__PURE__ */ new Date()).toISOString()), e._config.sendPayloadChecksums && typeof Promise < "u" && Promise.toString().indexOf("[native code]") !== -1 ? vt(t, h).then(function(f) {
              f && o.setRequestHeader("Bugsnag-Integrity", f), o.send(h);
            }).catch(function(f) {
              e._logger.error(f), o.send(h);
            }) : o.send(h);
      ...
      t || !e._isBreadcrumbTypeEnabled("log") || k(zr, function(n) {
        ...
        console[n] = function() {
          for (var a = arguments.length, c = new Array(a), o = 0; o < a; o++)
            c[o] = arguments[o];
          e.leaveBreadcrumb("Console output", u(c, function(h, f, g) {
            var v = "[Unknown value]";
            try {
              v = String(f);
            } catch {
...
`)), T = S - 1, w = Math.max(T - 3, 0), M = Math.min(T + 3, A.length);
    ...
    var $e = function(e, t) {
      ...
      var c = t[n];
      t[n] = function(o, h, f) {
        e.leaveBreadcrumb("History " + n, Zr(r, o, h, f), "navigation"), a && typeof e.resetEventCount == "function" && e.resetEventCount(), c.apply(t, [o, h].concat(f !== void 0 ? f : []));
      };
    }, Pt = function(e) {
      try {
        ...
        load: function(n) {
          ...
          function r(c, o, h, f, g) {
            if (h === 0 && /Script error\.?/.test(c))
              ...
              if (g)
                y = n.Event.create(g, !0, v, t, 1), wt(y.errors[0].stacktrace, o, h, f);
              else if (
                ...
                typeof c == "object" && c !== null && (!o || typeof o != "string") && !h && !f && !g
              ) {
                ...
                y = n.Event.create(c, !0, v, t, 1), wt(y.errors[0].stacktrace, o, h, f);
              n._notify(y);
            }
        ...
        load: function(n) {
          if (!(!n._config.autoDetectErrors || !n._config.enabledErrorTypes.unhandledRejections)) {
            var r = function(a) {
              ...
              var h = !n._config.reportUnhandledPromiseRejectionsAsHandled, f = n.Event.create(c, !1, {
                severity: "error",
                unhandled: h,
                severityReason: {
              ...
              o && k(f.errors[0].stacktrace, an(c)), n._notify(f, function(g) {
...
const vn = (d) => new Vt(typeof d == "string" ? d : d + "", void 0, Ye), mn = (d, ...i) => {
  const s = d.length === 1 ? d[0] : i.reduce((u, l, p) => u + ((_) => {
  ...
  return new Vt(s, d, Ye);
}, yn = (d, i) => {
  if (Ge) d.adoptedStyleSheets = i.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet);
  else for (const s of i) {
    const u = document.createElement("style"), l = Ae.litNonce;
    l !== void 0 && u.setAttribute("nonce", l), u.textContent = s.cssText, d.appendChild(u);
  }
}, Tt = Ge ? (d) => d : (d) => d instanceof CSSStyleSheet ? ((i) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: bn, defineProperty: Sn, getOwnPropertyDescriptor: $n, getOwnPropertyNames: En, getOwnPropertySymbols: An, getPrototypeOf: On } = Object, q = globalThis, Rt = q.trustedTypes, xn = Rt ? Rt.emptyScript : "", qe = q.reactiveElementPolyfillSupport, ce = (d, i) => d, Je = { toAttribute(d, i) {
  switch (i) {
    case Boolean:
      d = d ? xn : null;
      break;
  ...
  return s;
} }, qt = (d, i) => !bn(d, i), Mt = { attribute: !0, type: String, converter: Je, reflect: !1, useDefault: !1, hasChanged: qt };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const le = globalThis, Oe = le.trustedTypes, Lt = Oe ? Oe.createPolicy("lit-html", { createHTML: (d) => d }) : void 0, Kt = "$lit$", V = `lit$${Math.random().toFixed(9).slice(2)}$`, Xt = "?" + V, Nn = `<${Xt}>`, Y = document, de = () => Y.createComment(""), he = (d) => d === null || typeof d != "object" && typeof d != "function", Ze = Array.isArray, Pn = (d) => Ze(d) || typeof (d == null ? void 0 : d[Symbol.iterator]) == "function", Ke = `[ 	
\f\r]`, ue = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Bt = /-->/g, Ht = />/g, J = RegExp(`>|${Ke}(?:([^\\s"'>=/]+)(${Ke}*=${Ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), It = /'/g, Dt = /"/g, zt = /^(?:script|style|textarea|title)$/i, wn = (d) => (i, ...s) => ({ _$litType$: d, strings: i, values: s }), Cn = wn(1), ne = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), kt = /* @__PURE__ */ new WeakMap(), W = Y.createTreeWalker(Y, 129);
function Jt(d, i) {
  if (!Ze(d) || !d.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Lt !== void 0 ? Lt.createHTML(i) : i;
}
const Tn = (d, i) => {
  const s = d.length - 1, u = [];
      ...
      if (l.nodeType === 1) {
        ...
        if (zt.test(l.tagName)) {
          ...
          if (H > 0) {
            ...
            for (let D = 0; D < H; D++) l.append(P[D], de()), W.nextNode(), E.push({ type: 2, index: ++p });
            l.append(P[H], de());
          }
        }
...
function ie(d, i, s = d, u) {
  var _, O;
  if (i === ne) return i;
  let l = u !== void 0 ? (_ = s._$Co) == null ? void 0 : _[u] : s._$Cl;
  const p = he(i) ? void 0 : i._$litDirective$;
  return (l == null ? void 0 : l.constructor) !== p && ((O = l == null ? void 0 : l._$AO) == null || O.call(l, !1), p === void 0 ? l = void 0 : (l = new p(d), l._$AT(d, s, u)), u !== void 0 ? (s._$Co ?? (s._$Co = []))[u] = l : s._$Cl = l), l !== void 0 && (i = ie(d, l._$AS(d, i.values), l, u)), i;
}
class Rn {
  constructor(i, s) {
...
class ge {
  ...
  k(i) {
    ...
    const s = this._$AH;
    let u, l = 0;
    for (const p of i) l === s.length ? s.push(u = new ge(this.O(de()), this.O(de()), this, this.options)) : u = s[l], u._$AI(p), l++;
...
const In = (d, i, s) => {
  ...
  if (l === void 0) {
    ...
    u._$litPart$ = l = new ge(i.insertBefore(de(), p), p, void 0, s ?? {});
  }
  return l._$AI(d), l;
};
/**
...
var jt;
fe._$litElement$ = !0, fe.finalized = !0, (jt = G.litElementHydrateSupport) == null || jt.call(G, { LitElement: fe });
const ze = G.litElementPolyfillSupport;
ze == null || ze({ LitElement: fe });
...
let kn = async () => ({});
async function Un(d) {
  re[d] ?? (re[d] = {}), re[d][We] || (re[d][We] = await kn());
}
function Ut(d, i, s) {
  var l, p;
  return (((p = (l = re[d]) == null ? void 0 : l[We]) == null ? void 0 : p[i]) ?? `${d}.${i}?`).replace(/\{\{(\w+)\}\}/g, (_, O) => "");
}
class Wt extends fe {
  constructor() {
    super(...arguments);
    oe(this, "basepath", "/apps/bar-manager");
    oe(this, "route", "/");
    oe(this, "env");
  }
  async connectedCallback() {
    var s, u;
    super.connectedCallback(), await Un("bar"), (u = (s = this.env) == null ? void 0 : s.bus) == null || u.addEventListener(Dn, () => this.requestUpdate());
  }
  render() {
    return Cn`<h2>${Ut("bar", "title")}</h2>
      <p>${Ut("bar", "intro")}</p>`;
  }
}
oe(Wt, "styles", mn`
  ...
  `);
customElements.define("bar-shell", Wt);
function qn(d) {
  const i = d.monitoring ?? (() => {
    var u, l;
    const s = _n.start({
      apiKey: void 0,
      releaseStage: void 0,
      appVersion: ((u = d.app) == null ? void 0 : u.version) ?? "0.0.0",
      appType: `microapp:${((l = d.app) == null ? void 0 : l.slug) ?? "unknown"}`,
  ...
  i.addMeta("microapp", d.app), i.breadcrumb("microapp:mounted", { ...d.app }, "state");
}
export {
  qn as register
};
