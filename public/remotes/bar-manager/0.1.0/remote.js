 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: yt, defineProperty: vt, getOwnPropertyDescriptor: Et, getOwnPropertyNames: bt, getOwnPropertySymbols: St, getPrototypeOf: wt } = Object, f = globalThis, G = f.trustedTypes, Ct = G ? G.emptyScript : "", D = f.reactiveElementPolyfillSupport, P = (r, t) => r, V = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Ct : null;
      break;
...
let E = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(P("properties"))) {
      const e = this.properties, s = [...bt(e), ...St(e)];
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, lt = /^(?:script|style|textarea|title)$/i, Ut = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Ot = Ut(1), b = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), it = /* @__PURE__ */ new WeakMap(), g = y.createTreeWalker(y, 129);
function ct(r, t) {
...
class T {
  ...
  _$AI(t, e = this) {
    t = S(this, t, e), H(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== b && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : xt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class L {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = S(this, t, e, 0), o = !H(t) || t !== this._$AH && t !== b, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = S(this, a[s + h], e, h), c === b && (c = this._$AH[h]), o || (o = !H(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
class dt extends U {
  constructor() {
    super(...arguments);
    w(this, "basepath", "/apps/bar-manager");
    w(this, "route", "/");
    w(this, "env");
  }
  async connectedCallback() {
    var e, s;
    super.connectedCallback(), await ft("bar"), (s = (e = this.env) == null ? void 0 : e.bus) == null || s.addEventListener($t, () => this.requestUpdate());
  }
  render() {
    return Ot`<h2>${K("bar", "title")}</h2>
      <p>${K("bar", "intro")}</p>`;
  }
}
w(dt, "styles", gt`
  ...
  `);
customElements.define("bar-shell", dt);
function jt() {
}
export {
  jt as register
